...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.EventViewHolder> {
    private final Activity activity;
    private ArrayList<Event> events = new ArrayList<>();
    private eventAdapterListener mEventAdapterListener;

    public RecommendedAdapter(Activity activity, eventAdapterListener eventAdapterListener) {
